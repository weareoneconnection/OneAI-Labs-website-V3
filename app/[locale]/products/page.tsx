...
const meta = {
  en: {
    ...
    description: "Five products carry the company — OneAI Core, OneForge, TheOne, OneAI Construction and OneVideo Studio. Everything else runs on the same stack and is listed under Labs, with the stage its evidence supports."
  },
  zh: {
    title: "产品 · OneAI 产品生态",
    description: "五个产品支撑起这家公司——OneAI Core、OneForge、TheOne、OneAI Construction 和 OneVideo Studio。其余的跑在同一套技术栈上，列在 Labs 之下，并各自标注证据支持的阶段。"
  }
};
...
const hero = {
  en: {
    eyebrow: "Products",
    title: "Five products, and everything else.",
