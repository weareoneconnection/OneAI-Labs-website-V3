...
export type SolutionContent = {
  ...
  deliveryBody: string;
  delivery: { title: string; text: string; icon: LucideIcon }[];
  limitsTitle: string;
  limits: string[];
  ctaHeading: string;
  ctaBody: string;
      ...
      <section className="border-y border-white/10 bg-white/[0.025]">
        <div className="site-shell-wide section-y">
          ...
          <div className="mt-14 max-w-3xl">
            <p className="section-eyebrow">{t.deliveryEyebrow}</p>
            <h3 className="section-title mt-4">{t.deliveryHeading}</h3>
            <p className="mt-5 text-base leading-7 text-slate-400 sm:text-lg sm:leading-8">{t.deliveryBody}</p>
          </div>
          ...
          <div className="mt-10 max-w-3xl rounded-2xl border border-oneai-gold/20 bg-oneai-gold/[0.07] p-5">
